...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy and Affiliate Disclosure for Nutara Tales.',
};
  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-3xl">
      ...
      <div className="prose prose-lg prose-green max-w-none text-text">
        ...
        <p>
          Like any other website, Nutara Tales uses &quot;cookies&quot;. These cookies are used to store information including visitors&apos; preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users&apos; experience by customizing our web page content based on visitors&apos; browser type and/or other information.
        </p>
        ...
        <p>
          Nutara Tales is a participant in the Amazon Services LLC Associates Program, an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to Amazon.com and affiliated sites.
        </p>
        <p>
