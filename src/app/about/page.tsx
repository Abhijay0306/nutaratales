...
export const metadata: Metadata = {
  title: 'About',
  description: 'Learn about Nutara Tales, our sustainability mission, and content philosophy.',
};

export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-3xl">
      <h1 className="text-4xl md:text-5xl font-serif font-bold text-dark mb-8">About Nutara Tales</h1>
      ...
      <div className="prose prose-lg prose-green max-w-none text-text">
        <p className="lead text-xl text-text/80 mb-8 border-l-4 border-primary pl-6">
          Nutara Tales is dedicated to making sustainable living accessible, practical, and beautiful.
        </p>
        ...
        <h2 className="font-serif text-2xl text-dark mt-12 mb-4">The Nutara Tales Brand Story</h2>
        <p>
          Nutara Tales began with a simple question: <em>&quot;How can we minimize our footprint while maximizing our culinary and lifestyle experiences?&quot;</em>
        </p>
        <p>
          What started as a personal challenge to cook without fire and reduce kitchen waste quickly grew into a passion for exploring all facets of eco-friendly living. Today, Nutara Tales serves as a hub for a growing community of readers who share our commitment to a sustainable future.
        </p>
      </div>
    </div>
  );
